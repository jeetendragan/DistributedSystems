...
public class SimpleMessengerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, "My port number is: "+myPort, Toast.LENGTH_SHORT).show();
        ...
        //Toast.makeText(this, "Current value inside edit text:"+editText.getText().toString(), Toast.LENGTH_SHORT).show();
        /*
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try {
                while(true)
                {
                    ...
                    String msg = "";
                    msg = inp.readUTF();
                    //while((msg = inp.readUTF()) != null){
                        // String message = inp.readUTF();
                        Log.println(Log.DEBUG, "Server","Message rec by server:"+msg);
                        publishProgress(msg);
                }
            } catch (IOException e) {
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                Log.println(Log.DEBUG, "Client","Write message to server:"+msgToSend);
                //socket.close();
